 ...
 const getUser = async (id) =>{
  ...
  return (
    <section className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-xl sm:text-2xl md:text-3xl font-normal sm:font-extrabold mb-6 text-gray-800">
        Comments Dashboard
      </h1>
          ...
          <tbody className="divide-y divide-gray-200">
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <button 
                    onClick={()=>getProduct(c.product?._id)}
                    className="cursor-pointer ml-3 px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded hover:bg-blue-200 transition">
                      Show
                    </button>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-normal break-words text-sm text-gray-700 max-w-xs">
                  {c.comment}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
            ...
            {comments.length === 0 && (
              <tr>
                <td
                  colSpan="6"
                  className="py-6 px-6 text-center text-gray-400 italic"
                >
