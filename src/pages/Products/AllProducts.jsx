            ...
            {products.map((d) => (
              <div key={d._id} className="relative rounded-lg flex flex-col items-center">
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <Link to={`/product/${d._id}`} className="hidden md:block px-4 py-1.5 cursor-pointer text-gray-500 border border-gray-500/20 rounded-full text-xs hover:bg-slate-100 transition">Buy now</Link>
                </div>
